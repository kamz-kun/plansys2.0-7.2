<head>
     ...
     <?php Asset::registerCSS('application.themes.sidebar.views.css.multilevelpushmenu'); ?>
     <?php
     ...
     <?php Asset::registerJS('application.themes.sidebar.views.js.multilevelpushmenu'); ?>
     <script>
          paceOptions = {
            ajax: false, // disabled
